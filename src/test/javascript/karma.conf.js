...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'src/main/webapp/bower_components/blob-util/dist/blob-util.js',
            'src/main/webapp/bower_components/blueimp-load-image/js/load-image.js',
            'src/main/webapp/bower_components/blueimp-load-image/js/load-image-ios.js',
             'src/main/webapp/bower_components/blueimp-load-image/js/load-image-orientation.js',
             'src/main/webapp/bower_components/blueimp-load-image/js/load-image-meta.js',
             'src/main/webapp/bower_components/blueimp-load-image/js/load-image-exif.js',
             'src/main/webapp/bower_components/blueimp-load-image/js/load-image-exif-map.js',
             'src/main/webapp/bower_components/angular-ahdin/dist/ahdin.js',
