...
public class BookResourceIntTest {
    ...
    public void createBook() throws Exception {
        ...
        assertThat(testBook.getPhoto()).isEqualTo(DEFAULT_PHOTO);
    }
    ...
    public void updateBook() throws Exception {
        ...
        updatedBook.setPhoto(UPDATED_PHOTO);
        ...
        assertThat(testBook.getPhoto()).isEqualTo(UPDATED_PHOTO);
    }
